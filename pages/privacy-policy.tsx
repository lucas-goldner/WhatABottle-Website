  ...
  return (
    <div>
      ...
      <p>
        ...
        Ralf Lampl, Tim Baumgartner, Lucas Goldner. The use of the Internet
        pages of the Ralf Lampl, Tim Baumgartner, Lucas Goldner is possible
      ...
      <p>
        ...
        Ralf Lampl, Tim Baumgartner, Lucas Goldner. By means of this data
      ...
      <p>
        As the controller, the Ralf Lampl, Tim Baumgartner, Lucas Goldner has
      ...
      <h4>1. Definitions</h4>
      <p>
        The data protection declaration of the Ralf Lampl, Tim Baumgartner,
        Lucas Goldner is based on the terms used by the European legislator for
      ...
      <p>Ralf Lampl, Tim Baumgartner, Lucas Goldner</p>
      <p>Zinkbrunnerstr. 12</p>
      <p>70327 Stuttgart</p>
      <p>Germany</p>
      <p>Phone: +496934868650</p>
      <p>Email: hello@whatabottle.co</p>
      <p>Website: www.whatabottle.co</p>

      <h4>3. Cookies</h4>
      <p>
        The Internet pages of the Ralf Lampl, Tim Baumgartner, Lucas Goldner use
        cookies. Cookies are text files that are stored in a computer system via
        an Internet browser.
      </p>
      ...
      <p>
        Through the use of cookies, the Ralf Lampl, Tim Baumgartner, Lucas
        Goldner can provide the users of this website with more user-friendly
      ...
      <p>
        The website of the Ralf Lampl, Tim Baumgartner, Lucas Goldner collects a
      ...
      <p>
        When using these general data and information, the Ralf Lampl, Tim
        Baumgartner, Lucas Goldner does not draw any conclusions about the data
        ...
        prosecution in case of a cyber-attack. Therefore, the Ralf Lampl, Tim
        Baumgartner, Lucas Goldner analyzes anonymously collected data and
      ...
      <p>
        On the website of the Ralf Lampl, Tim Baumgartner, Lucas Goldner, users
      ...
      <p>
        The Ralf Lampl, Tim Baumgartner, Lucas Goldner informs its customers and
      ...
      <p>
        The newsletter of the Ralf Lampl, Tim Baumgartner, Lucas Goldner
        ...
        on the embedded tracking pixel, the Ralf Lampl, Tim Baumgartner, Lucas
        Goldner may see if and when an e-mail was opened by a data subject, and
      ...
      <p>
        ...
        controller. The Ralf Lampl, Tim Baumgartner, Lucas Goldner automatically
        regards a withdrawal from the receipt of the newsletter as a revocation.
      </p>

      <h4>8. Contact possibility via the website</h4>
      <p>
        The website of the Ralf Lampl, Tim Baumgartner, Lucas Goldner contains
      ...
      <p>
        The comments made in the blog of the Ralf Lampl, Tim Baumgartner, Lucas
        Goldner may be subscribed to by third parties. In particular, there is
        the possibility that a commenter subscribes to the comments following
      ...
      <ul style={{ listStyle: "none" }}>
        ...
        <li>
          ...
          <p>
            ...
            wishes to request the erasure of personal data stored by the Ralf
            Lampl, Tim Baumgartner, Lucas Goldner, he or she may, at any time,
            contact any employee of the controller. An employee of Ralf Lampl,
            Tim Baumgartner, Lucas Goldner shall promptly ensure that the
          ...
          <p>
            ...
            as processing is not required. An employees of the Ralf Lampl, Tim
            Baumgartner, Lucas Goldner will arrange the necessary measures in
            individual cases.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            stored by the Ralf Lampl, Tim Baumgartner, Lucas Goldner, he or she
            may at any time contact any employee of the controller. The employee
            of the Ralf Lampl, Tim Baumgartner, Lucas Goldner will arrange the
        ...
        <li>
          ...
          <p>
            ...
            may at any time contact any employee of the Ralf Lampl, Tim
            Baumgartner, Lucas Goldner.
          </p>
        </li>
        <li>
          ...
          <p>
            The Ralf Lampl, Tim Baumgartner, Lucas Goldner shall no longer
            process the personal data in the event of the objection, unless we
          ...
          <p>
            If the Ralf Lampl, Tim Baumgartner, Lucas Goldner processes personal
            ...
            concerning him or her for such marketing. This applies to profiling
            to the extent that it is related to such direct marketing. If the
            data subject objects to the Ralf Lampl, Tim Baumgartner, Lucas
            Goldner to the processing for direct marketing purposes, the Ralf
            Lampl, Tim Baumgartner, Lucas Goldner will no longer process the
          ...
          <p>
            ...
            data concerning him or her by the Ralf Lampl, Tim Baumgartner, Lucas
            Goldner for scientific or historical research purposes, or for
          ...
          <p>
            ...
            contact any employee of the Ralf Lampl, Tim Baumgartner, Lucas
            Goldner. In addition, the data subject is free in the context of the
        ...
        <li>
          ...
          <p>
            ...
            consent, the Ralf Lampl, Tim Baumgartner, Lucas Goldner shall
        ...
        <li>
          ...
          <p>
            ...
            Ralf Lampl, Tim Baumgartner, Lucas Goldner.
          </p>
        </li>
      </ul>
      <h4>
      ...
      <p>
        The operating company of Affilinet is the affilinet GmbH, Sapporobogen
        6-8, 80637 München, Germany.
      </p>
      ...
      <h4>
        20. Data protection provisions about the application and use of
        Instagram
      </h4>
      <p>
      ...
      <h4>
        24. Data protection provisions about the application and use of
        DoubleClick
      </h4>
      <p>
      ...
      <p>
        The operating company of DoubleClick by Google is Google Ireland
        Limited, Gordon House, Barrow Street, Dublin, D04 E5W5, Ireland.
      </p>
      ...
      <h4>
        25. Data protection provisions about the application and use of Awin
      </h4>
      <p>
        On this website, the controller has integrated components by Awin. Awin
        is a German affiliate network that offers affiliate marketing. Affiliate
        marketing is an Internet-based sales form that enables commercial
        operators of Internet sites, the so-called merchants or advertisers, to
        place advertising that is usually paid via click or sale commissions on
        third-party websites, also called affiliates or publishers (e.g. sales
        partners). The merchant provides, through the affiliate network, an
        advertising medium, e.g. an advertising banner or other suitable means
        of Internet advertising, which is subsequently integrated by an
        affiliate on their own Internet pages or promoted via other channels,
        such as keyword advertising or e-marketing.
      </p>

      <p>
        The operating company of Awin is Awin AG, Eichhornstraße 3, 10785
        Berlin, Germany.
      </p>

      <p>
        Awin sets a cookie on the information technology system of the data
        subject. The definition of cookies is explained above. The tracking
        cookie of Awin does not store any personal data. Only the identification
        number of the affiliate, that is, the partner mediating the potential
        customer, as well as the ordinal number of the visitor of a website and
      ...
      <p>
        ...
        of the web browser used and thus permanently deny the setting of
        cookies. Such an adjustment to the Internet browser used would also
        prevent Awin from setting a cookie on the information technology system
        of the data subject. In addition, cookies already in use by Awin may be
        deleted at any time via a web browser or other software programs.
      </p>

      <p>
        The applicable data protection provisions of Awin may be retrieved under
        http://www.Awin.com/us/about-Awin/privacy/.
      </p>

      <h4>
        26. Data protection provisions about the application and use of Adcell
      </h4>
      <p>
      ...
      <p>
        The operating company of AdCell is Firstlead GmbH, Rosenfelder St.
      ...
      <h4>
        27. Data protection provisions about the application and use of Adgoal
      </h4>
      <p>
      ...
      <h4>
        28. Data protection provisions about the application and use of ADITION
      </h4>
      <p>
      ...
      <h4>
        29. Data protection provisions about the application and use of AdJug
      </h4>
      <p>
      ...
      <p>
        The operating company of AdJug is AdJug Ltd. 5th Floor Glen House,
        200-208 Tottenham Court Road, London, W1T7PL, United Kingdom.
      </p>
      ...
      <h4>
        30. Payment Method: Data protection provisions about the use of PayPal
      ...
      <h4>31. Legal basis for the processing</h4>
      <p>
      ...
      <h4>33. Period for which the personal data will be stored</h4>
      <p>
      ...
      <h4>
        34. Provision of personal data as statutory or contractual requirement;
      ...
      <h4>35. Existence of automated decision-making</h4>
      <p>
      ...
      <p>
        ...
        <a href="https://willing-able.com/">LegalTech</a> at Willing & Able that
        also developed the system for
        <a href="https://abletorecords.com/">completed dpia example</a>. The
        legal texts contained in our privacy policy generator have been provided
        and published by
        <a href="https://dg-datenschutz.de/">
          Prof. Dr. h.c. Heiko Jonny Maniero
        </a>
        from the German Association for Data Protection and
        <a href="https://www.wbs.legal/" rel="nofollow">
          Christian Solmecke
        </a>{" "}
        from WBS law.
      </p>
